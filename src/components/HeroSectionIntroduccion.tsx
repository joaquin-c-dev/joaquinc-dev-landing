            ...
            */}
            ...
            <div className="space-y-4 md:space-y-6 lg:space-y-8 text-center max-w-2xl">
              ...
              <p className="text-base lg:text-lg text-muted-foreground/90 leading-relaxed">
                Aprende los fundamentos de la programación desde cero. Un curso
                completo en vivo que te llevará desde los conceptos básicos de
                algoritmos hasta la programación orientada a objetos con Java.
              </p>
...
91:               */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  onClick={() => {
                    const temarioSection = document.querySelector(
                      '[data-section="temario-introduccion"]',
                    );
                    if (temarioSection) {
