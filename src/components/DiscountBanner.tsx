          ...
          <div className="flex items-center gap-2 ml-4">
            <div className="relative">
              ...
              <Button
                onClick={scrollToCTA}
                size="sm"
                className="relative bg-white/10 hover:bg-white/20 text-white border border-white/30 font-bold text-xs md:text-sm px-4 md:px-5 py-2 md:py-3 transform hover:scale-105 transition-all duration-300"
              >
