          ...
          <Card className="p-6 bg-gradient-card border-primary/20 shadow-glow hover:shadow-glow-lg transition-all duration-300">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold">11 Abr - 23 May 2026</div>
                  <div className="text-sm text-muted-foreground">7 semanas de duración (no hay clase el 2 de mayo por el Día del Trabajo)</div>
                </div>
              </div>
...
export default ProximosIniciosSectionIntroduccion;