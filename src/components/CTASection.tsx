...
const CTASection = () => {
  return (
    <section data-section="cta" className="py-12 min-h-screen flex items-center bg-course-darker relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 bg-gradient-card border-primary/20 shadow-glow-lg relative overflow-hidden">
            {/* Decorative elements */}
