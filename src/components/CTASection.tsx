...
const CTASection = () => {
  return (
    <section className="py-24 bg-java-darker relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 bg-gradient-glow opacity-20"></div>
      <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-tech-cyan/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-java-orange/10 rounded-full blur-3xl"></div>
          ...
          <Card className="p-12 bg-gradient-card border-primary/20 shadow-glow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg" 
                  className="shadow-glow-lg hover:shadow-glow transition-glow bg-gradient-primary hover:bg-gradient-primary/90 text-lg px-12 py-4"
                >
                  Inscríbete Ahora
