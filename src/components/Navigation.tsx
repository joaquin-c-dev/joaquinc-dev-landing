            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-background/95 backdrop-blur-md border border-border/50 z-50">
                ...
                <DropdownMenuItem
                  ...
                  className={`cursor-pointer hover:text-[#fff] hover:!bg-transparent focus:!bg-transparent data-[highlighted]:!bg-transparent transition-colors duration-200 font-medium ${
