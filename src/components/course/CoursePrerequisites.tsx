...
const PREREQUISITE_ITEMS_NOTE =
  "No es necesario ser experto, solo tener nociones básicas.";

const PREREQUISITE_COURSE_PROMPT = "¿Aún no tienes estos conocimientos?";
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-gradient-card border-primary/20">
            ...
            <div className={courseLink ? "space-y-2" : "space-y-2 mb-4"}>
            ...
            {courseLink && (
              <div className="mt-2">
                <p className="text-xs italic text-muted-foreground mb-4">
                  {PREREQUISITE_ITEMS_NOTE}
                </p>
                <p className="text-xs text-muted-foreground mb-2">
                  {PREREQUISITE_COURSE_PROMPT}
                </p>
