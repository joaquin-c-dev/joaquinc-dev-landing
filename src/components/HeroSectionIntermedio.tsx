            ...
            */}
            ...
            <div className="space-y-4 md:space-y-6 lg:space-y-8 text-center max-w-2xl">
              ...
              <p className="text-base lg:text-lg text-muted-foreground/90 leading-relaxed">
                Lleva tus conocimientos de Java al siguiente nivel. Aprende
                patrones de diseño, testing profesional, seguridad con JWT,
                persistencia con JPA y mucho más para crear aplicaciones backend
